...
public:
    ...
    // Función virtual pura (= 0), equivalente a abstracta (las hijas tienen que implementarla obligatoriamente).
    //Si una clase hija no implementa la función será también una clase abstracta y no podrá instanciarse
    /**
